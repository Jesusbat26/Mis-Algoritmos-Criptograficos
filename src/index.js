...
const argv = yargs(process.argv.slice(2))
    ...
    handler: () => {
        ...
        console.log(keys.publicKey.export({ type: 'pkcs1', format: 'pem' }).toString());
        console.log(keys.privateKey.export({ type: 'pkcs1', format: 'pem' }).toString());
    }
})
    .command({
    command: 'sign',
